...
> "Lab 1, abrid `labs/01-ask-mode/README.md`. Tienen 15 minutos. Empezad por el Ejercicio 1 y avanzad a vuestro ritmo."
...
> "Si queréis profundizar, hay un Lab 5 extra en el repositorio sobre cómo configurar Copilot para que siempre respete los estándares de vuestro equipo — y mucho más que puede hacer la carpeta `.github` de vuestros proyectos. Está en [`labs/05-copilot-instructions/README.md`](labs/05-copilot-instructions/README.md)."
...
**Material**: [labs/05-copilot-instructions/README.md](labs/05-copilot-instructions/README.md)  
...
**Material**: [labs/06-custom-agents/README.md](labs/06-custom-agents/README.md)  
